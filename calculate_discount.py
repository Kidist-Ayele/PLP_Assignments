...
# 2. Using the calculate_discount function, prompt the user to 
# enter the original price of an item and the discount percentage. 
# Print the final price after applying the discount, or if no discount 
